...
describe('inquirer-directory#file', function() {
  var prompt;
  var rl;
  ...
  it('should list  folders and files', function () {
      prompt.run();
      expect(rl.output.__raw__).contain('folder1');
      expect(rl.output.__raw__).contain('zfolder2');
  });
  ...
  it('should contain files', function () {
      prompt.run();
      expect(rl.output.__raw__).to.contain('some.png');
  });
